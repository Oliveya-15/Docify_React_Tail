...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id='speciality'>
        ...
        <p className='sm:w-1/3 text-center text-sm'>Find top doctors, book appointments, and manage your health easily. Your health journey starts here with trusted care.</p>
